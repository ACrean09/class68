...
modelConfiguration = '/Users/shucrean/Desktop/TNK-M9-PRO-C68-SAS-BP-main/SA1/cfg/yolov3.cfg'
modelWeights = '/Users/shucrean/Desktop/TNK-M9-PRO-C68-SAS-BP-main/SA1/cfg/yolov3.weights'

labelsPath = '/Users/shucrean/Desktop/TNK-M9-PRO-C68-SAS-BP-main/SA1/coco.names'

labels = open(labelsPath).read().strip().split('\n')

yoloNetwork = cv2.dnn.readNetFromDarknet(modelConfiguration, modelWeights)

video = cv2.VideoCapture("/Users/shucrean/Desktop/TNK-M9-PRO-C68-SAS-BP-main/SA1/bb2.mp4")
...
def goalTrack(img, bbox):
    ...
    cv2.circle(img,(int(goalX),int(goalY)),2,(0,0,255),3)
